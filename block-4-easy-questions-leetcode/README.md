...
5-6 patterns wearing different clothes; recognizing the pattern is the actual skill.
Every problem listed below is Easy difficulty.

- **Two pointers**: Two Sum II (sorted), Valid Palindrome, Merge Sorted Array, Remove Duplicates from Sorted Array
...
- **Hashing / frequency counting**: Two Sum, Valid Anagram, Contains Duplicate, First Unique Character in a String, Ransom Note
- **Stack**: Valid Parentheses, Baseball Game, Remove All Adjacent Duplicates In String
