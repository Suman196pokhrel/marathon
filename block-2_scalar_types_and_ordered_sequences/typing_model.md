...
Strong typing : no silent coercion across unrelated types. "1" + 1 raises typeError. Contrast javascript, which returs "11".

Exception : numberic tower coerces internally. 1 + 2.0 -> 3.0, True + 1 -> 2.
The numeric tower
...
isinstance(x,C): appepts subclasses.Prefer isinstance, except when you specifically must reject subclasses (the bool/int case below).
